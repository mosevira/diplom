    ...
    <div class="container-fluid">
        ...
        <form action="<?php echo e(route('branches.update', $branch->id)); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" id="name" value="<?php echo e($branch->name); ?>" required>
            </div>
            <div class="form-group">
...
<?php /**PATH C:\OSPanel\domains\diplom\resources\views/branches/edit.blade.php ENDPATH**/ ?>